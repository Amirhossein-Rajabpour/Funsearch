...
def main(specification: str, inputs: Sequence[Any], config: config_lib.Config, prompt_spec: str = None):
  ...
  database = programs_database.ProgramsDatabase(
      config.programs_database, template, function_to_evolve, prompt_template)
...
if __name__ == '__main__':
  ...
  main(_CANT_STOP_SPEC, inputs=(3,), config=config_lib.Config(), prompt_spec=_CANT_STOP_PROMPT_SPEC)
